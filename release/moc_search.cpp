...
QT_MOC_LITERAL(5, 31, 17),
QT_MOC_LITERAL(6, 49, 8),
QT_MOC_LITERAL(7, 58, 6)
    },
    "Search\0newQuery\0\0mkQuery\0query\0"
    "changePlaceHolder\0QAction*\0action\0"
};
...
void Search::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->newQuery((*reinterpret_cast< const QString(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        case 1: _t->mkQuery((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 2: _t->changePlaceHolder((*reinterpret_cast< QAction*(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (Search::*_t)(const QString & , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Search::newQuery)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void Search::newQuery(const QString & _t1, int _t2)
{
