...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_MusicBrainZClient_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_MusicBrainZClient_t qt_meta_stringdata_MusicBrainZClient = {
    {
...
const QMetaObject MusicBrainZClient::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_MusicBrainZClient.data,
      qt_meta_data_MusicBrainZClient,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_MusicBrainZClient.stringdata))
